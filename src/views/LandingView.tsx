...
export function LandingView({ isAuthenticated, onLogout }: LandingViewProps) {
  return (
      ...
      <section aria-labelledby="hero-title" className="grid items-center gap-8 md:grid-cols-2 lg:gap-12">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            {isAuthenticated ? (
              <>
                <Button asChild id="cta" size="lg" className="h-10 px-6 text-sm font-semibold shadow-lg shadow-primary/30">
                  <Link to="/dashboard">Ir al Dashboard</Link>
                </Button>
                <Button asChild type="button" size="lg" variant="outline" className="h-10 px-6 text-sm font-semibold">
                  <Link to="/profile">Ver Perfil</Link>
                </Button>
                <Button type="button" size="lg" variant="outline" className="h-10 px-6 text-sm font-semibold" onClick={() => void onLogout()}>
                  Logout
                </Button>
              </>
            ) : (
            ...
            <Button asChild size="lg" variant="ghost" className="h-10 px-4 text-sm font-semibold">
